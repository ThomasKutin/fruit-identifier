...
try:
    model = tf.keras.models.load_model('my_fruit_model_finetuned.keras')
    print("Robot is ready!")
except:
    print("❌ Error: Could not find 'my_fruit_model_finetuned.keras'. Did you run the training script?")
    exit()
